...
public sealed class Workflow : AggregateRoot<WorkflowId>
{
        ...
        DateTime createdAt) : base(id)
    {
        ...
        RaiseDomainEvent(new WorkflowCreatedEvent(Id, Name.Value, CreatedAt));
    }
    ...
    public Result AddStep(string stepName, PluginId pluginId, Dictionary<string, object>? configuration = null, int? order = null)
    {
        ...
        RaiseDomainEvent(new WorkflowStepAddedEvent(Id, step.Value.Id, stepName));
    ...
    public Result Start()
    {
        ...
        RaiseDomainEvent(new WorkflowStartedEvent(Id, StartedAt.Value));
    ...
    public Result Complete()
    {
        ...
        RaiseDomainEvent(new WorkflowCompletedEvent(Id, CompletedAt.Value));
    ...
    public Result Fail(string errorMessage)
    {
        ...
        RaiseDomainEvent(new WorkflowFailedEvent(Id, ErrorMessage, CompletedAt.Value));
    ...
    public Result Pause()
    {
        ...
        RaiseDomainEvent(new WorkflowPausedEvent(Id, UpdatedAt));
    ...
    public Result Resume()
    {
        ...
        RaiseDomainEvent(new WorkflowResumedEvent(Id, UpdatedAt));
    ...
    public Result Cancel()
    {
        ...
        RaiseDomainEvent(new WorkflowCancelledEvent(Id, CompletedAt.Value));
    ...
    public Result UpdateDetails(string name, string description)
    {
        ...
        {
            RaiseDomainEvent(new WorkflowUpdatedEvent(Id, Name.Value, Description.Value, UpdatedAt));
        }
